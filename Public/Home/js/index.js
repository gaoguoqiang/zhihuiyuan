	...
	(function(){
		...
		$('.association p a').each(function(index){
			$(this).click(function(){
				...
				$(this).addClass('active');
				$('.association_pic').hide();
				$('.association_pic').eq(index).show();
				$('.pic img').each(function(){
					picBlowUp($(this));
		...
		$('.institution p a').each(function(index){
			$(this).click(function(){
				...
				$(this).addClass('active');
				$('.institution_pic').hide();
				$('.institution_pic').eq(index).show();
				$('.pic img').each(function(){
					picBlowUp($(this));
