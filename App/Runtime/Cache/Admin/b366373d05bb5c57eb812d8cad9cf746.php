...
<div id="contain" class="clear">
	...
	<div class="contain_main">
		<form action="/zhihuiyuan/Admin/User/update" method="post">
			<table border="1" align="center" id="abc">
			<tr>
				<td>用户名：</td>
				<td>
				<input type="text" name="uname" value="<?php echo ($result["uname"]); ?>" />
				<input type="hidden" name="unameid" value="<?php echo ($result["id"]); ?>" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>确认密码：</td>
				<td><input type="password" name="ypassword" /></td>
			</tr>
			<tr>
				<td>权限：</td>
