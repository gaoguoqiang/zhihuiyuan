...
<script src="/Public/Home/js/index.js"></script>
    ...
    <link rel="stylesheet" href="/Public/Home/css/lecturer_details.css">
...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <span>&gt;</span>
            <a class="now_page" href="/Reteacher/index/nid/17">讲师推荐</a>
            <span>&gt;</span>
        ...
        <div class="main_left">
            ...
            <?php else: ?>
                 <img class="head_pic" src="/Uploads/<?php echo ($teachOne["face"]); ?>"><?php endif; ?>
