...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <?php else: ?>
            <a class="now_page" href="/Company/commitList/nid/<?php echo ($title["id"]); ?>">><?php echo ($title["sername"]); ?></a><?php endif; ?>

            <?php if(empty($title2)): ?><span></span>
            <?php else: ?>
            <a class="now_page" href="/Company/commitList/id/<?php echo ($title2["id"]); ?>">><?php echo ($title2["sername"]); ?></a><?php endif; ?>
        ...
        <div class="article_list">
            ...
            <ul>
                ...
                <?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
                    <p><a href="/Company/commitList/id/<?php echo ($v['id']); ?>"><?php echo ($v["sername"]); ?></a></p>
            ...
            <?php if(empty($content["id"])): if(is_array($result2)): foreach($result2 as $key=>$v): ?><li>
                    <p><a href="/Company/commitList/iId/<?php echo ($v['id']); ?>"><?php echo ($v["infoname"]); ?></a></p>
                </li><?php endforeach; endif; ?>
                <div class="page">
                <table class="pages">
                    <tr>
