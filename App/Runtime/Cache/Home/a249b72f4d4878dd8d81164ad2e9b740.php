...
<script src="/Public/Home/js/index.js"></script>
    ...
    <link rel="stylesheet" href="/Public/Home/css/lecturer.css">
    ...
    <div id="content" class="clear">
        ...
        <?php if(is_array($result)): foreach($result as $key=>$v): ?><li class="clear">
                ...
                <?php else: ?>
                        ...
                        <img class="head_pic" src="/Uploads/<?php echo ($v["face"]); ?> "><?php endif; ?>
                ...
                <a href="/Reteacher/details/id/<?php echo ($v["id"]); ?>">详情</a>
