...
<script src="/zhihuiyuan/Public/Home/js/carousel.js"></script>
    ...
    <link rel="stylesheet" href="/zhihuiyuan/Public/Home/css/lecturer.css">
...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <span>&gt;</span>
            <a class="now_page" href="/zhihuiyuan/Reteacher/index/nid/17">讲师推荐</a>
      ...
      <!--    <?php if(is_array($result)): foreach($result as $key=>$v): if(empty($v["face"])): ?><div class="head_pic"></div>
                <?php else: ?>

                        <img class="head_pic" src="/zhihuiyuan/Uploads/<?php echo ($v["face"]); ?> "><?php endif; ?>
                ...
                <ul class="lecturer_info">
                    ...
                    <li class="clear">
                        <span>地址：</span>
                        <p>
                        <span>&nbsp;&nbsp;<?php echo ($v["prov"]); ?>&nbsp;&nbsp;&nbsp;</span>
                        <span><?php echo ($v["city"]); ?>&nbsp;&nbsp;&nbsp;</span>
                        <span><?php echo ($v["dist"]); ?>&nbsp;&nbsp;&nbsp;</span>
                        </p>
                    </li>
                    <li class="clear">
                        <span>擅长领域：</span>
                        <p><?php echo ($v["field"]); ?></p>
                    </li>
                    <li class="clear">
                        <span>技术特长：</span>
                        <p><?php echo ($v["technology"]); ?></p>
                    </li>
                    <li class="clear">
                        <span>个人简介：</span>
                ...
                <a href="/zhihuiyuan/Reteacher/details/id/<?php echo ($v["id"]); ?>">详情</a>
                            ...
                            if(data[i][city] == prov || !prov){
                                ...
                                if(i<page*6&&i>=(page-1)*6){
                                    ...
                                    if(data[i].face == null){
                                        //-------------
                                        if(data[i].sex == '女'){
                                            imgUrl = '/zhihuiyuan/Public/Home/img/default_head_wom.png';
                                        }else{
                                            imgUrl = '/zhihuiyuan/Public/Home/img/default_head_man.png';
                                        }
                                    }else{
                                        imgUrl = '/zhihuiyuan/Uploads/'+data[i].face;
                                    }
                                    str += '<li class="clear">\
