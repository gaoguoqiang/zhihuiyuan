...
<script src="/zhihuiyuan/Public/Home/js/carousel.js"></script>
    ...
    <link rel="stylesheet" href="/zhihuiyuan/Public/Home/css/personal_center.css">
...
<div id="main">
    ...
    <div id="content" class="clear">
        ...
        <?php if(empty($result2["face"])): ?><div class="head_pic"><img src="/zhihuiyuan/Public/Home/img/default_head_man.png" style="width:100%;height:100%;" /></div>
        <?php else: ?>
            <div class="head_pic"><img src="/zhihuiyuan/Uploads/<?php echo ($result2["face"]); ?>" style="width:100%;height:100%;"/></div><?php endif; ?>
            
            <?php if($result["vip"] == 1): ?><img class="vip" src="/zhihuiyuan/Public/Home/img/vip.png" style="margin:0 auto;">
            <?php else: ?>
            <img class="vip" src="/zhihuiyuan/Public/Home/img/vip_king.png" style="margin:0 auto;"><?php endif; ?>

            <p>积分：<span>2222</span></p>
            <a class="user_info" href="/zhihuiyuan/Personage/orgData">完善个人资料</a>
        ...
        <div class="main_right">
            <ul class="lecturer_info">
                ...
                <li class="clear">
                    <span>地址：</span>
                    <p><?php echo ($result2["prov"]); ?>&nbsp;&nbsp;<?php echo ($result2["city"]); ?>&nbsp;&nbsp;<?php echo ($result2["dist"]); ?></p>
                </li>
                <li class="clear">
                    <span>擅长领域：</span>
