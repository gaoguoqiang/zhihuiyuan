...
<script src="/Public/Home/js/index.js"></script>
    ...
    <link rel="stylesheet" href="/Public/Home/css/course_commit.css">
    <script src="/Public/Home/js/check.js"></script>
    <script src="/Public/Home/js/course_commit.js"></script>
...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <span>&gt;</span>
            <a class="now_page" href="/Contact/commit/nid/16">系列课程</a>
        ...
        <div class="article_list">
            ...
            <ul>
                ...
                <?php if(empty($title)): if(is_array($result)): foreach($result as $key=>$v): ?><li>
                            <p><a href="/Contact/commit/id/<?php echo ($v["id"]); ?>"><?php echo ($v["infoname"]); ?></a></p>
        ...
        <div class="article_main">
            ...
            <div class="apply clear">
                <h3>报名信息填写</h3>
                 ...
                 <form onsubmit="return checksubmit('course')" action="/Contact/addCommitUser" method="post">
                <ul class="apply_form">
                    <li>
