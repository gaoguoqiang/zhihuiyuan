...
<script src="/zhihuiyuan/Public/Home/js/carousel.js"></script>
    ...
    <link rel="stylesheet" href="/zhihuiyuan/Public/Home/css/reg.css">
...
<div id="main">
    ...
    <div id="content" class="clear">
    	<div class="reg_form">
    		<form action="/zhihuiyuan/Reg/insert" onsubmit="return checksubmit('reg')" method="post" enctype="multipart/form-data">
                <ul>
                    <li>
                        <label>
                            <input type="file" class="file_pic" name="userfile" id="file" />
                            <div class="head_pic" id="head_pic"><img src="/zhihuiyuan/Public/Home/img/big.jpg" id="img"> 上传头像
