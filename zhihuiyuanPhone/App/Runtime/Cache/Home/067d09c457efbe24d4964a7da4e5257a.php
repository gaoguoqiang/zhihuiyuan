...
<body>
	...
	<aside class="class_theme">
		...
		<div class="class_nav">
			...
			<ul>
			<?php if(is_array($re)): foreach($re as $key=>$v): ?><li><a href="/zhihuiyuanPhone/Glod/goldproject/id/<?php echo ($v[id]); ?>"><?php echo ($v["36name"]); echo ($v["dataname"]); ?></a></li><?php endforeach; endif; ?>	
			</ul>
