...
<link rel="stylesheet" href="/zhihuiyuan/Public/Home/css/public/page_nav.css">
    <link rel="stylesheet" href="/zhihuiyuan/Public/Home/css/news.css">
...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <span>&gt;</span>
            <a class="now_page" href="/zhihuiyuan/News/index">集群动态区</a>
        </div>
        <div class="article_list">
            <h4>名称</h4>
            <ul>
                <?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
                        <p><a href="/zhihuiyuan/News/showNews/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a></p>
        ...
        <div class="article_main">
            ...
            <?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
                    ...
                    <a href="/zhihuiyuan/News/showNews/id/<?php echo ($v["id"]); ?>"><h4 class="title"><?php echo ($v["title"]); ?></h4></a>
                    <a href="/zhihuiyuan/News/showNews/id/<?php echo ($v["id"]); ?>"><img src="/zhihuiyuan/Public/Home/img/6.png" alt=""></a>
                    <p class="content"><a href="/zhihuiyuan/News/showNews/id/<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></a></p>
                </li><?php endforeach; endif; ?>
            </ul>
