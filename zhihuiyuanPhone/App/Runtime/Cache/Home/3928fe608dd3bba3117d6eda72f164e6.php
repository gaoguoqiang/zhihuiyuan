...
<script src="/zhihuiyuan/Public/Home/js/index.js"></script>
    ...
    <link rel="stylesheet" href="/zhihuiyuan/Public/Home/css/train.css">
    <script type="text/javascript" src="/zhihuiyuan/Public/Home/js/jquery.js"></script>
...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <span>&gt;</span>
            <a class="now_page" href="/zhihuiyuan/Index/commitList1/nid/18">培训需求</a>
        </div>
        <ul class="content_list">
        
            <?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
                    <h2><?php echo ($v["title"]); ?></h2>
                    <span><a href="#"><?php echo ($v["name"]); ?></a><em><?php echo ($v["createtime"]); ?></em></span>
        ...
        <div class="issue">
            <form method="post" action="/zhihuiyuan/Train/add" onsubmit="return checksubmit('train')">
                <input class="title" type="text" name="title" value="标题">
                <textarea class="contain" name="content">内容</textarea>
                <input class="submit" type="submit" name="submit" value="提交">
                <span class="info">请先登录，未登录会导致发布需求失败，请留下电话方便我们与您联系！</span>
            </form>
        </div>
        <script>
            $(function(){
