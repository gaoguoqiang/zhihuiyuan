...
<script src="/zhihuiyuan/Public/Home/js/index.js"></script>
    ...
    <link rel="stylesheet" href="/zhihuiyuan/Public/Home/css/lecturer_details.css">
...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <span>&gt;</span>
            <a class="now_page" href="javascript:void(0)">详情</a>
        </div>
        <div class="main_left">

            <?php if(empty($teachOne["face"])): ?><div class="head_pic"></div>
            <?php else: ?>
                 <img class="head_pic" src="/zhihuiyuan/Uploads/<?php echo ($teachOne["face"]); ?>"><?php endif; ?>
            
            <p>收费情况：<span>2222</span></p>
            <a href="#">在线支付</a>
            <div class="map"></div>
        </div>
        <div class="main_right">
            <ul class="lecturer_info">
                <li class="clear">
                    <span>姓名：</span>
                    <p><?php echo ($teachOne1["user"]); ?></p>
                </li>
                <li class="clear">
                    <span>性别：</span>
                    <p><?php echo ($teachOne1["sex"]); ?></p>
                </li>
                <li class="clear">
                    <span>地址：</span>
                    <p>
                        <span>&nbsp;&nbsp;<?php echo ($teachOne["prov"]); ?>&nbsp;&nbsp;&nbsp;</span>
                        <span><?php echo ($teachOne["city"]); ?>&nbsp;&nbsp;&nbsp;</span>
                        <span><?php echo ($teachOne["dist"]); ?>&nbsp;&nbsp;&nbsp;</span>
                    </p>
                </li>
                <li class="clear">
                    <span>擅长领域：</span>
                    <p><?php echo ($teachOne["field"]); ?></p>
                </li>
                <li class="clear">
                    <span>技术特长：</span>
                    <p><?php echo ($teachOne["technology"]); ?></p>
                </li>
                <li class="clear">
                    <span>职位：</span>
                    <p>
            ...
            <p class="intro">
                <span>个人简介：</span>
                <?php echo ($teachOne["introduction"]); ?>
            </p>
