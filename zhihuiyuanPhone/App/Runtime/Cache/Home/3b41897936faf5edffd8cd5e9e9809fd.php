...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <?php else: ?>
            <a class="now_page" href="/zhihuiyuan/Index/commitList2/id/<?php echo ($title["id"]); ?>"><?php echo ($title["dataname"]); ?></a><?php endif; ?>
            <?php if(empty($title2)): ?><span></span>
            <?php else: ?>
            <a class="now_page" href="/zhihuiyuan/Index/commitList2/did/<?php echo ($title2["id"]); ?>">><?php echo ($title2["dataname"]); ?></a><?php endif; ?>
            <!-- 文章题目 -->
        ...
        <div class="article_list">
            ...
            <ul>
                ...
                <?php if(is_array($result)): foreach($result as $key=>$v): ?><li>
                    <p><a href="/zhihuiyuan/Index/commitList2/did/<?php echo ($v['id']); ?>"><?php echo ($v["dataname"]); ?></a></p>
