...
<div id="main">
    ...
    <div id="content" class="clear">
        <div class="page_nav">
            ...
            <span>&gt;</span>
            <a class="now_page" href="/zhihuiyuan/Personage/perfectInfo">完善个人资料</a>
        </div>
        <div class="reg_form">
            <form action="/zhihuiyuan/Personage/save" method="post" enctype="multipart/form-data">
                <ul class="clear">
                    <li class="form_user">
                    ...
                    <li>
                        <textarea class="intro" name="introduction" id="">个人简介：</textarea>
